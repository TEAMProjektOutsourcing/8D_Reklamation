        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <?php if ($user): ?>
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php endif; ?>
                    <?php if (is_admin()): ?>
                        <li class="nav-item"><a class="nav-link<?= nav_active('users.php', $currentPage) ?>" href="users.php">Benutzer</a></li>
                        <li class="nav-item"><a class="nav-link<?= nav_active('locations.php', $currentPage) ?>" href="locations.php">Standorte</a></li>
                    <?php endif; ?>
                </ul>
